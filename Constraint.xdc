...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { Center }];
...
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { a_to_g[7] }]; #IO_L19N_T3_A21_VREF_15 Sch=dp
